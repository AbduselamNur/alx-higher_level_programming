...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Stacic method that return begger or equal Are

        Args:
            rect_1 (int): Area of reactangle one
            rect_2 (int): Area of reactangle two
        """
    ...
    def square(cls, size=0):
        """
        class medthod square function

        Args:
            cls: function of rectangle
            size (int): size of width or height
        """
