...
def is_Safe(m_queen, nqueen):
    """ Method that check if the queens can or can't kill each other
...
def solve_NQue(size):
    """ Function invokes the Backtracking algorithm
